[![Build status](https://travis-ci.org/amy-actually/vue-design-system.svg?branch=master)](https://travis-ci.org/amy-actually/vue-design-system/) ![Dependencies status](https://david-dm.org/amy-actually/vue-design-system.svg) ![MIT License](https://img.shields.io/badge/license-MIT-blue.svg)

# Vue Design System

[**Vue Design System**](https://github.com/viljamis/vue-design-system) is an open source tool for building UI Design Systems with [Vue.js](https://vuejs.org). It provides you and your team a set of organized tools, patterns & practices that work as the foundation for your application development.
