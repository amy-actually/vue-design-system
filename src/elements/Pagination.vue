<template>
  <ul class="pagination">
    <li :class="{ disabled: onFirstPage }" class="page-item">
      <a @click.prevent="setPage(1)" class="page-link" rel="first" aria-label="First">
    ...
    <li class="page-item disabled">
      <a @click.prevent="setPage(paginator.value)" class="page-link" disabled="disabled">
      ...
      if (this.lastPage < this.eachSide * 2 + 4) {
        ...
        if (this.currentPage - this.firstPage < this.eachSide + 2) {
          ...
          for (
            ...
            i < Math.max(this.eachSide * 2 + 1, this.currentPage + this.eachSide + 1);
            ++i
          ) {
            paginators.push({
              value: i,
